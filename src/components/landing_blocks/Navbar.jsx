...
export function Navbar() {
  ...
  return (
    <nav className={`border-b border-slate-200/50 bg-white/80 backdrop-blur-md sticky top-0 z-50 transition-all duration-300 ${scrolled ? 'shadow-lg py-1' : 'shadow-sm py-2'}`}>
      <Container>
        <div className="flex items-center justify-between py-4">
          
          {/* 1. Logo */}
          <div className="flex items-center">
            <a href="/" className="flex items-center gap-2.5 text-primary font-extrabold text-2xl group">
              <div 
